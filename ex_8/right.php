...
<ol>
    <li>
        ...
        <div class="author">Maria De Lurdes Craveiro</div>
    </li>
    <li>
        <a href="#">Obras-primas da Arte Portuguesa - Século Xx - Artes Visuais</a>
        <div class="author">Delfim Sardo</div>
    </li>
    <li>
        <a href="#">Obras-primas da Arte Portuguesa - Escultura</a>
        <div class="author">Joaquim Oliveira Caetano</div>
    </li>
    <li>
        <a href="#">Deus e Caravaggio</a>
        <div class="author">Carlos Vidal</div>
    </li>
    <li>
        <a href="#">Whispering Paper (The)</a>
        <div class="author">Pedro Cabrita Reis</div>
    </li>
    <li>
        <a href="#">100 Ideias Para o Design de Apartamentos</a>
        <div class="author">Ana G. Cañizares</div>
    </li>
    <li>
    ...
    <li>
        ...
        <div class="author">Luís Campos</div>
    </li>
</ol>
<div>
</div>